...
def submit_request(jwt_token: Text, req_file_name: Text, endpoint_url: Text):
    """
    POST requst to api endpoint
    """
...
def main():
    ...
    submit_request(token, args.req_file_name, args.end_point_url)
